...
public class OBEXClient {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        if (serverURL == null) {
            String[] searchArgs = {"000110100001000800000805F9B34FB"};
            // Connect to OBEXPutServer from examples
            // searchArgs = new String[] { "11111111111111111111111111111123" };
            BthJavaClient.main(searchArgs);
            if (BthJavaClient.serviceFound.size() == 0) {
                System.out.println("OBEX service not found");
                return;
            }
            // Select the first service found
            serverURL = (String)BthJavaClient.serviceFound.elementAt(0);
        }
